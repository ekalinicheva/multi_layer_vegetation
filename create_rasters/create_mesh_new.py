...
def create_dsm(pos_points, pred_points, pred_raster, gt_height_raster, gt_points, geo, path_strata_coverage_pred, pl_id, gt_binary):
...
for pl_id in pl_id_list:
    ...
    dem, matrix_no_data = create_dsm(pos_points, pred_points, pred_raster, gt_height_raster[:, :H, :W], gt_points, geo, path_result, pl_id, gt_binary)
